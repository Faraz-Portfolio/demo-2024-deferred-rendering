  ...
  return (
    <>
      ...
      >
        ...
        >
          Experimenting with deferred rendering in React Three Fiber using a
          custom WebGL renderer. GBuffer is rendered all in one pass using WebGL
      ...
      >
        <a
          href={`https://github.com/Faraz-Portfolio/${packageJson.name}`}
          target="_blank"
          rel="noopener noreferrer"
          style={{
            width: "3rem",
